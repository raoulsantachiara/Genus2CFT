...
\section{Orbifold conformal blocks in terms of sphere conformal blocks}\label{sphere_conf_blocks}
...
\bibitem{Borisov} L. Borisov, M. B. Halpern and C. Schweigert, \emph{Systematic approach to cyclic orbifolds}, 
